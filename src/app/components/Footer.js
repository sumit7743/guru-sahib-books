            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-8">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-auto">
                    <div className="h-32 w-32 bg-white rounded-full mb-4 mx-auto md:mx-0 relative overflow-hidden border border-green-500">
                        <Image src={'/images/author_ds.jpg'} fill alt='Author' style={{ objectFit: 'cover' }} />
                    </div>
                ...
                <div className="flex flex-col md:items-end w-full md:w-auto gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-end">
                        <span className="text-lg md:text-xl font-semibold mb-4 text-gray-200">Social Links</span>
                        <div className="flex gap-6">
                            <Link href={'https://youtube.com/@punjabdarshanenttv?si=FgZNMgNy9d45I-f1'} target='_blank'>
                                <div className="w-8 h-8 md:h-10 md:w-10 rounded-full cursor-pointer transition-colors flex items-center justify-center">
                            ...
                            <Link href={'https://www.facebook.com/profile.php?id=61584367072607'} target='_blank'>
                                <div className="w-8 h-8 md:h-10 md:w-10 rounded-full cursor-pointer transition-colors flex items-center justify-center">
